...
TXT;
    ...
    public function edit(Request $request)
    {
        ...
        $coverLetters = $request->user()->coverLetters()->orderByDesc('is_default')->orderByDesc('created_at')->get();
    ...
    public function update(Request $request)
    {
        ...
        $profile->fill([
            ...
            // Composed from the structured fields above so every other reader
            // of profile.location (job search default, admin user view,
            // {location} template placeholder) keeps working unchanged.
