...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Bulk Apply'); ?></title>
    <script>
...
<body>
    <header>
        <nav class="nav">
            ...
            <a class="link <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>" href="<?php echo e(route('profile.edit')); ?>">Profile &amp; Template</a>
