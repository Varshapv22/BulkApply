...
const NAV = [
    ...
    { href: '/pipeline',     label: 'Pipeline',  match: '/pipeline',  icon: 'kanban' },
...
function Icon({ name, className = 'h-[18px] w-[18px] shrink-0' }) {
    const paths = {
        ...
        kanban: <><rect x="3" y="3" width="5" height="18" rx="1.3" /><rect x="9.5" y="3" width="5" height="11" rx="1.3" /><rect x="16" y="3" width="5" height="7" rx="1.3" /></>,
